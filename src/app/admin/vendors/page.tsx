                  ...
                  <>
                    <tr key={rowKey} className={`hover:bg-slate-50 transition-colors ${open ? 'bg-slate-50/80' : ''}`}>
                      ...
                      <td className="py-3 px-4 align-top">
                        ...
                        {/* Wallet Address: break-all to see the full address */}
                        <div className="mt-1 text-xs font-mono text-slate-600 break-all" title={v.walletAddress}>
                            ...
                            {(v.phone || v.whatsapp) && (
                                <div className="flex items-center text-slate-700">
                                    ...
                                    <span className="mr-1.5 flex-shrink-0" style={{ width: '14px', height: '14px' }}>
                                        <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-slate-500">
