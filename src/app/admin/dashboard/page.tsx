...
type SortKey = 'bidsCount' | 'totalAwardedUSD' | 'lastBidAt' | 'vendorName' | 'walletAddress';
                ...
                <>
                  ...
                  >
                    <td className="py-2 px-3 font-medium">
                      {v.vendorName || '—'} {v.archived ? <span className="text-xs text-slate-500">(archived)</span> : null}
                    </td>
